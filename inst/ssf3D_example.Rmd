...
### Habitat selection
We have one habitat covariate in our model (`cov`). We can interpret its coefficient as relative selection strength; its effect is multiplicative, such that taking the exponential of the estimated $\beta$ indicates how many times more likely the animal is to take a step if the covariate increases by 1 (keeping everything else constant). 
```{r rss1}
